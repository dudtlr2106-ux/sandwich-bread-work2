                                      ...
                                      >
                                          {isAdmin && (
                                            <>
                                              ...
                                              <DropdownMenuItem onClick={() => openPartialTimeDialog(worker, dateKey, day, "partial_overtime", "A")} className="text-blue-600">
                                                <Clock className="h-4 w-4 mr-2" />
                                                시간잔업
                                              </DropdownMenuItem>
                                              ...
                                              <DropdownMenuItem onClick={() => openPartialTimeDialog(worker, dateKey, day, "partial_vacation", "A")} className="text-green-600">
                                                <Clock className="h-4 w-4 mr-2" />
                                                시간휴가
                                              </DropdownMenuItem>
                                      ...
                                      >
                                          {isAdmin && (
                                            <>
                                              ...
                                              <DropdownMenuItem onClick={() => openPartialTimeDialog(worker, dateKey, day, "partial_overtime", "B")} className="text-blue-600">
                                                <Clock className="h-4 w-4 mr-2" />
                                                시간잔업
                                              </DropdownMenuItem>
                                              <DropdownMenuItem onClick={() => setWorkerStatus(worker, dateKey, "vacation")} className="text-green-600">
