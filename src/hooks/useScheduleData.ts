...
// 조별 근무자 구조
// A조: 반장 김영식, 1조 (김광시, 서민성, 백승빈), 2조 (장영광, 연명옥, 이상민)
// B조: 반장 박노일, 1조 (강윤묵, 김용주, 김순기), 2조 (윤기은, 오세홍, 고장윤)
...
// A조(초반): 반장 김영식, 1조+2조 (물류: 김광시, 검사: 서민성/백승빈, 설비: 장영광/연명옥/이상민)
// B조(중반): 반장 박노일, 1조+2조 (물류: 강윤묵, 검사: 김용주/김순기→고장윤/윤기은, 설비: 오세홍/고장윤/윤기은→윤기은/오세홍/고장윤)
